    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100 ">
      ...
      <div className="flex gap-12 sm:gap-12  flex-col sm:flex-row ">
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-gray-500 mt-5 flex flex-col gap-1 ">
            <p>100% originalm product.</p>
            <p>Cush on delivery is available in this product.</p>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500">
          <p>
            An e-commerce website is an online platform that facilitates thge
            buying and selling of products or service over the internet . it
            serves as a virtual marketplace where businesses and individuals can
            shwocase thier products, interact with customers, and conduct
            transactions wothout the need for a physical presence. E-commerce
            have gained immense popularity due to thier convenience,
